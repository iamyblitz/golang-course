...
const file_proto_collector_collector_proto_rawDesc = "" +
	...
	"\n" +
	"created_at\x18\x05 \x01(\tR\tcreatedAt2q\n" +
	"\tCollector\x12d\n" +
	"\x11GetRepositoryInfo\x12&.collector.v1.GetRepositoryInfoRequest\x1a'.collector.v1.GetRepositoryInfoResponseB%Z#repo-stat/proto/collector;collectorb\x06proto3"
...
var file_proto_collector_collector_proto_depIdxs = []int32{
	0, // 0: collector.v1.Collector.GetRepositoryInfo:input_type -> collector.v1.GetRepositoryInfoRequest
	1, // 1: collector.v1.Collector.GetRepositoryInfo:output_type -> collector.v1.GetRepositoryInfoResponse
